    ...
    public static partial class SqlMapperExtensions
    {
        ...
        public static long Insert<T>(this IDbConnection connection, T entityToInsert, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            ...
            else if (type.IsInterface)
            {
                ...
                MethodInfo method = typeof(SqlMapperExtensions).GetMethod(nameof(Insert));
                ...
                foreach (var item in listToInsert)
                {
                    try
                    {
                        generic.Invoke(null, new object[] { connection, item, transaction, commandTimeout });
                        returnVal++;
                    }
                    catch (Exception ex)
                    {
        ...
        {
            ProxyGenerator.IProxy proxy = null;
            if (entityToUpdate is ProxyGenerator.IProxy tmpProxy)
            {
                if (!tmpProxy.IsDirty)
                {
                    return false;
